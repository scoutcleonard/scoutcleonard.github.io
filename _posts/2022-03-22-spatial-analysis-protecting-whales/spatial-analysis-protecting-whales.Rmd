...
Then I change the CRS from WGS 84 to Dominica 1945 for a more accurate geospatial reference system for the region of interest, coastal Domina:
...
Next, I import Define file path for whale sighting spatial data:
